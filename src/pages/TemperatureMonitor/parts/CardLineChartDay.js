...
export default function CardLineChartDay({ data }) {
  ...
  return (
    <>
      <div className="relative  rounded-lg flex flex-col min-w-0 break-words bg-white w-full">
        <div className="rounded-t mb-0 px-4 pt-3 ">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full max-w-full flex-grow flex-1">
              <h6 className="uppercase mt-3 text-blueGray-100 mb-1 text-xs font-semibold">ENERGY</h6>
